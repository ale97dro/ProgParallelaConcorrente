	...
	public void run() {
		...
		while (--cnt > 0) {
			final String key = getClass().getSimpleName()
					+ random.nextInt(Esercizio1Concurrent.NUM_WORKERS);
...
public class Esercizio1Concurrent {
	static final int NUM_WORKERS = 50;

	public static void main(final String[] args) {
		System.out.println("Esercizio 1 ConcurrentHashMap");
