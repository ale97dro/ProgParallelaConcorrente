package Esercizio2ConcCollection;
...
class ReadWorker implements Runnable {
	...
	public void run() {
		...
		while (Esercizio2ConcCollection.isRunning) {
			compareCounter++;
			final StringBuffer sb = new StringBuffer();

			// Build phrase string from shares words
			final Iterator<String> iterator = Esercizio2ConcCollection.sharedPhrase.iterator();
...
public class Esercizio2ConcCollection {
	...
	public static void main(final String[] args) {
		System.out.println("Esercizio2ConcCollection");
		...
		// Share list
		Esercizio2ConcCollection.sharedPhrase = list;
		...
		for (int i = 0; i < 10; i++) {
			Esercizio2ConcCollection.sharedPhrase.add(getWord());
			try {
				Thread.sleep(1000);
